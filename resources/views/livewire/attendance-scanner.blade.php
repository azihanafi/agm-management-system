        ...
        @elseif($step == 2)
            ...
            <div class="space-y-8 text-center">
                <div class="space-y-2">
                    ...
                    <h2 class="text-2xl font-bold text-white">{{ $memberInfo->name }}</h2>
                    <p class="text-slate-400">{{ $memberInfo->workplace }}</p>
                    <p class="text-sm font-mono text-red-400">{{ $memberInfo->staff_id }}</p>
                </div>
                
                <div class="grid grid-cols-1 gap-4 pt-4">
                    <a href="{{ route('nominate.index') }}" 
                ...
                <div class="pt-6 border-t border-white/5 space-y-6">
                    <div>
                        ...
                        <input wire:model="input_tac" type="text" maxlength="6" 
                            ...
                            placeholder="••••••">
                        @error('input_tac') <span class="text-red-400 text-xs mt-2 block">{{ $message }}</span> @enderror
                    </div>
        ...
        @elseif($step == 3)
            ...
            <div class="text-center space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-slate-400 text-sm">Welcome back, {{ explode(' ', $memberInfo->name)[0] }}</p>
                </div>
