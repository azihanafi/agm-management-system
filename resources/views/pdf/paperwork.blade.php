...
<body>
    ...
    <div class="header-info">
        <table class="header-table">
            ...
            <tr>
                ...
                <td class="separator">:</td>
                <td>{{ $paperwork->daripada }}</td>
            </tr>
            <tr>
                <td class="label">TARIKH</td>
                <td class="separator">:</td>
                <td>{{ \Carbon\Carbon::parse($paperwork->tarikh)->format('d F Y') }}</td>
            </tr>
        </table>
        ...
        <table class="title-table">
            <tr>
                ...
                <td class="separator">:</td>
                <td style="font-weight: bold; text-transform: uppercase;">{{ $paperwork->perkara }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="content">
        Adalah dimaklumkan bahawa FJB Group Sport Club akan menganjurkan program <strong>{{ $paperwork->program_title }}</strong> yang akan diadakan pada ketetapan berikut:
        <br><br>
        <table style="margin-left: 40px;">
            <tr><td width="100">Tarikh</td><td>: {{ \Carbon\Carbon::parse($paperwork->program_date)->format('d F Y') }}</td></tr>
            <tr><td>Hari</td><td>: {{ $paperwork->program_day }}</td></tr>
            <tr><td>Masa</td><td>: {{ $paperwork->program_time }}</td></tr>
            <tr><td>Tempat</td><td>: {{ $paperwork->program_location }}</td></tr>
        </table>
        <br>
    ...
    <div class="content">
        {!! nl2br(e($paperwork->syarat_penyertaan)) !!}
    </div>

    <div class="section-title">3) <span>CADANGAN SYARAT PERTANDINGAN</span></div>
    <div class="content">
        {!! nl2br(e($paperwork->cadangan_syarat)) !!}
    </div>
    ...
    <table class="data-table">
        ...
        <tbody>
            @foreach($paperwork->itineraryItems as $item)
            <tr>
    ...
    <table class="data-table">
        ...
        <tbody>
            @foreach($paperwork->budgetItems as $index => $item)
            <tr>
        ...
        <tfoot>
            <tr class="total-row">
                ...
                <td align="right">RM {{ number_format($paperwork->budgetItems->sum('total_price'), 2) }}</td>
            </tr>
        </tfoot>
    </table>
