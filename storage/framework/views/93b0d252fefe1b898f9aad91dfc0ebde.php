<div class="max-w-4xl mx-auto p-8 bg-white/5 border border-white/10 rounded-3xl shadow-2xl backdrop-blur-xl" wire:key="bulk-upload-wrapper">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$csvFile): ?>
                    <div 
                ...
                <?php else: ?>
                    <div class="p-5 bg-indigo-600/10 border border-indigo-600/20 rounded-2xl flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs font-bold text-white truncate max-w-[150px]"><?php echo e($csvFile->getClientOriginalName()); ?></p>
                                <p class="text-[10px] text-indigo-400 font-bold uppercase tracking-widest"><?php echo e($totalRows); ?> rows detected</p>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <table class="w-full text-left text-[10px]">
                            ...
                            <tbody class="divide-y divide-white/5">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $previewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="px-4 py-2 text-white font-medium truncate max-w-[100px]"><?php echo e($row[0]); ?></td>
                                        <td class="px-4 py-2 text-indigo-400 font-mono"><?php echo e($row[1]); ?></td>
                                        <td class="px-4 py-2 text-gray-500 truncate max-w-[80px]"><?php echo e($row[2]); ?></td>
                                    </tr>
                ...
                <button 
                    ...
                    <?php if(!$csvFile || $totalRows <= 0 || $isProcessing): ?> disabled <?php endif; ?>
                ...
                >
                    <span wire:loading.remove wire:target="upload">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($csvFile): ?>
                            Confirm & Sync <?php echo e($totalRows); ?> Members
                        <?php else: ?>
                            Waiting for File...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </span>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($importSummary): ?>
        <div class="mt-10 p-8 rounded-3xl animate-in zoom-in-95 duration-500 <?php echo e($importSummary['success'] ? 'bg-green-500/10 border border-green-500/20' : 'bg-red-500/10 border border-red-500/20'); ?>">
            <div class="flex items-center gap-4 mb-8">
                <div class="w-14 h-14 rounded-2xl flex items-center justify-center <?php echo e($importSummary['success'] ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($importSummary['success']): ?>
                ...
                <div>
                    <h4 class="text-2xl font-black <?php echo e($importSummary['success'] ? 'text-green-400' : 'text-red-400'); ?>">
                        <?php echo e($importSummary['message']); ?>

                    </h4>
                    <p class="text-gray-500 text-xs uppercase tracking-widest font-black mt-1">Status Report: <?php echo e(now()->format('H:i:s')); ?></p>
                </div>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($importSummary['success']): ?>
                <div class="grid grid-cols-3 gap-6 mb-8">
                    <div class="bg-black/40 p-5 rounded-2xl text-center border border-white/5">
                        ...
                        <div class="text-3xl font-black text-green-400"><?php echo e($importSummary['count']); ?></div>
                    </div>
                    <div class="bg-black/40 p-5 rounded-2xl text-center border border-white/5">
                        <div class="text-[10px] text-gray-500 uppercase font-black mb-2">Duplicates</div>
                        <div class="text-3xl font-black text-yellow-400"><?php echo e($importSummary['skipped']); ?></div>
                    </div>
                    <div class="bg-black/40 p-5 rounded-2xl text-center border border-white/5">
                        <div class="text-[10px] text-gray-500 uppercase font-black mb-2">Failures</div>
                        <div class="text-3xl font-black text-red-400"><?php echo e($importSummary['errors']); ?></div>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logs): ?>
                ...
                <div class="bg-black/60 rounded-2xl p-6 max-h-64 overflow-y-auto space-y-2 border border-white/10 font-mono">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-[10px] flex items-start gap-4">
                            <span class="text-gray-700 font-bold shrink-0"><?php echo e(now()->format('H:i')); ?></span>
                            <span class="<?php echo e(str_contains($log, 'CRITICAL') ? 'text-red-400' : (str_contains($log, 'Duplicate') ? 'text-yellow-400/60' : 'text-gray-300')); ?>">
                                <?php echo e($log); ?>
...
<?php /**PATH C:\Users\aziha\.gemini\antigravity\scratch\agm-voting-system\resources\views/livewire/bulk-member-upload.blade.php ENDPATH**/ ?>