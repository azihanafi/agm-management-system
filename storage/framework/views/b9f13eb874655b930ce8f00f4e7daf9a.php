    ...
    <div class="bg-white shadow-2xl rounded-lg overflow-hidden border border-gray-200">
        ...
        <div class="bg-slate-900 py-6 px-10 text-white flex justify-between items-center">
            ...
            <div class="text-right">
                <span class="px-3 py-1 rounded-full text-xs font-semibold uppercase <?php echo e($status === 'approved' ? 'bg-green-500 text-white' : ($status === 'rejected' ? 'bg-red-500 text-white' : 'bg-yellow-500 text-black')); ?>">
                    Status: <?php echo e(str_replace('_', ' ', $status)); ?>
                ...
                <div class="overflow-x-auto rounded-lg border border-gray-200">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $itineraryItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="text" wire:model="itineraryItems.<?php echo e($index); ?>.time" placeholder="08:00 AM" class="border-none focus:ring-0 w-32 text-sm">
                                </td>
                                <td class="px-6 py-4">
                                    <input type="text" wire:model="itineraryItems.<?php echo e($index); ?>.activity" placeholder="Pendaftaran Peserta" class="border-none focus:ring-0 w-full text-sm">
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <button wire:click="removeItineraryItem(<?php echo e($index); ?>)" class="text-red-400 hover:text-red-600">
            ...
            <section class="space-y-6">
                ...
                <div class="overflow-x-auto rounded-lg border border-gray-200">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $budgetItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-4 py-4 text-sm text-gray-400"><?php echo e($index + 1); ?></td>
                                <td class="px-4 py-4">
                                    <input type="text" wire:model.blur="budgetItems.<?php echo e($index); ?>.description" placeholder="Item perbelanjaan" class="border-none focus:ring-0 w-full text-sm">
                                </td>
                                <td class="px-4 py-4 text-right">
                                    <input type="number" step="0.01" wire:model.live="budgetItems.<?php echo e($index); ?>.price" class="border-none focus:ring-0 w-full text-right text-sm">
                                </td>
                                <td class="px-4 py-4 text-right">
                                    <input type="number" wire:model.live="budgetItems.<?php echo e($index); ?>.quantity" class="border-none focus:ring-0 w-full text-right text-sm">
                                </td>
                                <td class="px-4 py-4 text-center">
                                    <input type="text" wire:model.blur="budgetItems.<?php echo e($index); ?>.unit" class="border-none focus:ring-0 w-full text-center text-sm">
                                </td>
                                ...
                                <td class="px-4 py-4 text-right">
                                    <button wire:click="removeBudgetItem(<?php echo e($index); ?>)" class="text-red-400 hover:text-red-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
                                        </svg>
                                    </button>
                        ...
                        <tfoot class="bg-slate-900 text-white">
                            <tr>
                                ...
                                <td class="px-6 py-4 text-right text-lg font-black">RM <?php echo e(number_format($total_budget, 2)); ?></td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
        ...
        <div class="bg-slate-50 p-8 border-t border-gray-100 flex justify-between items-center">
            ...
            <div class="flex space-x-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($current_level == 2): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($current_level, [2,3,4])): ?>
                    <button wire:click="reject(<?php echo e($current_level); ?>)" class="px-6 py-2 bg-red-600 text-white rounded-md text-sm font-semibold hover:bg-red-700 transition">
                        Tolak
                    </button>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\aziha\.gemini\antigravity\scratch\agm-voting-system\resources\views/livewire/paperwork-manager.blade.php ENDPATH**/ ?>